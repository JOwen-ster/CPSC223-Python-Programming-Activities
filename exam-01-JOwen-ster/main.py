...
print(student.homework_average(grades=g, student_id=70314))
print(classroom.homework_average(grades=g, assignment_no=0))

testinghwaa = {11111: {'name': 'Student 1', 'homework': [60, 80], 'laboratory': [80, 100]}, 22222: {'name': 'Student 2', 'homework': [65, 85], 'laboratory': [65, 85]}, 33333: {'name': 'Student 3', 'homework': [95, 75], 'laboratory': [100, 70]}}
print(classroom.homework_average_average(testinghwaa))